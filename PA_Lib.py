...
class Percent:
    ...
    def __getitem__(self, item: str):
        if item in self.valid_keys[0]:
            if item == 'max_percent': return self.max_percent
            elif item == 'min_percent': return self.min_percent
            elif item == 'constants': return self.constants
        else:
